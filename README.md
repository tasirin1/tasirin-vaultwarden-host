...
3. Tekan **Start**. Status menunjukkan server berjalan.
4. Buka `http://127.0.0.1:8080` lewat tombol **Open Web UI**, atau dari perangkat
   lain pakai `http://<IP-lokal-android>:8080`.
